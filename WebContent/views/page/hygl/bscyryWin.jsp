...
<form id="singleForm" method="post" action="<%=request.getContextPath() %>/tHyChryController/savetHyChry" accept-charset="utf-8" >
    <!-- 主键 -->
    <input name="hy_id" value="${hy_id}" type="hidden">
    <!-- 外部人员 -->
    ...
    <div id="dialog" style="width:500px;">
        <table class="chry_tb bs_tb">
            <tr>
                ...
                <!-- 单位选择 -->
                <td style="width:75%">
                    <input style="width:97%" type="text" name="dwName" class="validate[required]">
                </td>
            </tr>
            <tr>
                <td class="bt">姓名</td>
                <td><input style="width:97%" type="text"  name="xm" class="validate[required]"></td>
            </tr>
            <tr>
                <td class="bt">性别</td>
            ...
            <tr>
                <td class="bt">职务</td>
                <td><input style="width:97%" type="text" name="zw" class="validate[required]"></td>
            </tr>
            <tr class="normal">
                <td class="bt">住宿</td>
            ...
            <tr class="normal">
                <td class="bt">联系方式</td>
                <td><input style="width:97%" type="text" name="lxfs" id="lxfs"></td>
            </tr>
            <tr class="qj" style="display:none">
                <td class="bt">事由</td>
                <td><textarea style="width:97%;height:80px;" name="bz" id="bz"></textarea></td>
            </tr>
        </table>
    </div>
</div>
