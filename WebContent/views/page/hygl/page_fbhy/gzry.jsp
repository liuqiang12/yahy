...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadListData(flag) {
            $.ajax({
                type: "POST",
                url: contextPath+"/tHyChryController/queryWinList?hyId=${hyEntity.id}&lbZt=1",
                dataType: 'json',
                async:false,
...
<div class="container">
    <div id="dialog">
        ...
        <div class="row">
            ...
            <label style="float:right;margin:0"><a href="javascript:void(0);" onclick="uploadWordForChry('${hyEntity.id}','1')">生成word</a></label>
